      ...
      this.iter(from.line, to.line + 1, function (line) {
        ...
        if (spans) {
          for (var i = 0; i < spans.length; i++) {
            var span = spans[i];
            if (
              !((span.to != null && lineNo$$1 == from.line && from.ch >= span.to) || (span.from == null && lineNo$$1 != from.line) || (span.from != null && lineNo$$1 == to.line && span.from >= to.ch)) &&
  ...
  CodeMirror.defineMode("css", function (config, parserConfig) {
    ...
    states.documentTypes = function (type, stream, state) {
      ...
      if (type == "word" && documentTypes.hasOwnProperty(stream.current())) {
        override = "tag";
        stateReturn = state.context.type;
      } else {
        stateReturn = states.atBlock(type, stream, state);
      }
      return stateReturn;
    };
...
function update(editor) {
  if (editor == "richTextEditor") {
    ...
    //Update design tab when clicking
