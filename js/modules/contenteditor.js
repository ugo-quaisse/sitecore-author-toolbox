  ...
  chrome.storage.sync.get((storage) => {
    ...
    if (!scQuickInfo) {
      ...
      if (storage.feature_experimentalui) {
        ...
        if (ScItem.id == "{11111111-1111-1111-1111-111111111111}") {
          ...
          scEditorPanel.insertAdjacentHTML(
            "afterbegin",
          ...
          chrome.runtime.sendMessage({ greeting: "sxa_site" }, function (
            ...
            document.querySelector(".scPreviewButton")
              ? document
                  ...
                  .setAttribute(
                    "onclick",
                    "window.open('" + sitecoreItemPath + "'); return false;"
                  )
              : false;
    ...
    if (storage.feature_cetabs) {
      ...
      for (var section of scEditorSectionCaption) {
        ...
        //Detect active panel
        if (
          sectionClass == "scEditorSectionCaptionExpanded" &&
