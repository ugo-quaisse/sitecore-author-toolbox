...
export let isPublishWindow = windowLocationHref.includes('/applications/publish.aspx');
export let isPublishDialog = windowLocationHref.includes('/publishing/publishdialog');
export let isSecurityWindow = windowLocationHref.includes('/applications/security/');
export let isEditUser = windowLocationHref.includes('security.edituser.aspx');
...
export let isLaunchpad = windowLocationHref.includes('/applications/launchpad');
...
export let isExperienceProfile = windowLocationHref.includes('/applications/experienceprofile/');
