...
const checkUrlStatus = (status, source = null, dark, experimental = false) => {
  let liveUrlStatus, html, preview, disable, barStyle, urlLoader;
  ...
  liveUrlStatus
    ? (liveUrlStatus.innerHTML =
        ...
        urlLoader +
        '" style="width: 10px; float: initial; margin: unset;"/>')
    : false;

  //Check response
  if (status == "404") {
    html =
      "<span class='liveStatusRed'><img loading='lazy' src=' " +
      global.dotRed +
      "'/> Not published (" +
      status +
      ")</span>";
    preview =
      "Live URL (404) <img loading='lazy' src=' " +
      global.dotRed +
      "' class='liveUrlDot' />";
    disable = true;
    barStyle = "scError";
    ...
    html =
      ...
      ")</span>";
    preview =
      "Live URL (500) <img loading='lazy' src=' " +
      global.dotRed +
      "'class='liveUrlDot' />";
    disable = true;
    barStyle = "scError";
    ...
    html =
      "<span class='liveStatusGreen'><img loading='lazy' src=' " +
      global.dotGreen +
      "'/> Published</span>";
    preview =
      "Live URL <img loading='lazy' src=' " +
      global.dotGreen +
      "'class='liveUrlDot' />";
    disable = false;
    barStyle = "scSuccess";
