  ...
  if (
    ...
    if (global.isContentEditor || global.isLaunchpad) {
      ...
      if (
        ...
        var scFavoritesIframe = document.querySelector(
      ...
      storage.feature_workbox == undefined
        ...
        : false;
      !chrome.runtime.error && storage.feature_workbox === true
        ? checkWorkbox()
        : false;
    }
    //End CE
    ...
    if (
      ...
      storage.feature_launchpad == undefined
        ? (storage.feature_launchpad = true)
        : false;
      ...
      if (storage.feature_launchpad) {
        var html =
          ...
          "</div></div></a>";
        // //Find last dom item
        var desktopOptionMenu = document.querySelectorAll(
          ".scStartMenuLeftOption"
        );
          ...
          if (event.target.offsetParent != null) {
            if (event.target.offsetParent.matches(".scContentTreeNodeNormal")) {
              ...
              document
                ...
                .setAttribute("style", "opacity:0.5");
              document.querySelector(
                ".scEditorTabHeaderActive > span"
              ).innerText = global.tabLoadingTitle;
    ...
    observer = new MutationObserver(function (mutations) {
      ...
      if (scQuickInfo) {
        ...
        var scEditorTitle = document.getElementsByClassName(
          "scEditorHeaderTitle"
        );

        var tabSitecoreItemID = document.querySelectorAll(
          ".scEditorHeaderQuickInfoInput"
        );
        var lastTabSitecoreItemID = tabSitecoreItemID[
          tabSitecoreItemID.length - 2
        ].getAttribute("value");
        ...
        if (
          countTab > 1 &&
          !document.getElementById("showInContentTree" + countTab + "")
        ) {
