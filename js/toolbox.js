...
import {
    showSnackbar
} from './modules/snackbar.js';
import {
    checkWorkbox
} from './modules/workbox.js';
import {
    checkUrlStatus
} from './modules/url.js';
import {
...
} from './modules/contenteditor.js';
import {
    getGravatar
} from './modules/users.js';
import {
    instantSearch
} from './modules/instantsearch.js';
import {
    insertModal,
    insertPanel
...
chrome.storage.sync.get((storage) => {
    ...
    if (global.isEditMode && !global.isLoginPage || global.isPreviewMode && !global.isLoginPage) {
        ...
        //Observer
        (storage.feature_experienceeditor && target) ? observer.observe(target, {
            attributes: false,
            childList: true,
            characterData: false
        }): false;
